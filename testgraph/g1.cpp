...
int main(int argc, char *argv[])
{
    ...
    button_module clear6(1025, 300, 1025 + 75, 375, 10, 10, 25,
                         ...
                         _T(" button8"));
    button_module clear7(1025, 800, 1025 + 75, 875, 10, 10, 25,
                         0xdddddd, BGR(0x56adcf), BGR(0x0ad55d), 0x000000, BGR(0xffff00), BGR(0xf638a3), _T("CLS"),
                         _T(" button9"));

    button_module copy1(1025, 500, 1025 + 75, 575, 10, 10, 25,
    ...
    for (;;)
    {
        ...
        for (; !message_deque().empty(); last_mes = message_pop_front())
        {
            ...
            /*additional 2*/
            if (cur_mes.sign.target == _T(" switch1_mode"))
            {
                mode_swit++;
                if (mode_swit > 2)
                    mode_swit = 0;
            ...
            if (cur_mes.sign.target == _T(" switch2_mode"))
            {
                game_mode = !game_mode;
